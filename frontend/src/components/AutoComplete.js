...
export default function GoogleMaps({ api, setLongitude, setLatitude }) {
  ...
  const setLongLat = async (newValue) => {
    await axios
      .get(
        `https://maps.googleapis.com/maps/api/place/details/json?placeid=${newValue.place_id}&key=${api}`
      )
      .then((res) => {
